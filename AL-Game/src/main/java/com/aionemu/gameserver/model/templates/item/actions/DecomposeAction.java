...
import com.aionemu.gameserver.model.templates.decomposable.DecomposableList;
...
public class DecomposeAction extends AbstractItemAction
{
	...
	public boolean canAct(Player player, Item parentItem, Item targetItem) {
		...
		if (decomposeLevel == -1 || decomposeLevel > player.getLevel()) {
			...
			PacketSendUtility.sendPacket(player, SM_SYSTEM_MESSAGE.STR_DECOMPOSE_ITEM_INVALID_STANCE(new DescriptionId(2800159)));
			return false;
