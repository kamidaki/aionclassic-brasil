...
{
	private static final Logger log = LoggerFactory.getLogger(C_CLIENTSIDE_NPC_ACTION.class);
	...
	public C_CLIENTSIDE_NPC_ACTION(int opcode, State state, State... restStates)
	{
