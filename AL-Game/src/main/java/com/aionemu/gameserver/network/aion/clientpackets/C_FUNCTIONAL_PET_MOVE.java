...
public class C_FUNCTIONAL_PET_MOVE extends AionClientPacket
{
	...
	public C_FUNCTIONAL_PET_MOVE(int opcode, AionConnection.State state, AionConnection.State... restStates)
	{
