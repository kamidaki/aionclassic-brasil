...
public class C_PARTY_MATCH extends AionClientPacket
{
	private static final Logger log = LoggerFactory.getLogger(C_PARTY_MATCH.class);
	private int action;
	...
	public C_PARTY_MATCH(int opcode, State state, State... restStates)
	{
