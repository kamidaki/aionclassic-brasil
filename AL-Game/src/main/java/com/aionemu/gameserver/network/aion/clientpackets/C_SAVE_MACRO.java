 ...
 * @author SoulKeeper
 */
public class C_SAVE_MACRO extends AionClientPacket
{

	/**
	 * Logger
	 */
	private static final Logger log = LoggerFactory.getLogger(C_SAVE_MACRO.class);
	 ...
	 * @param opcode
	 */
	public C_SAVE_MACRO(int opcode, State state, State... restStates)
	{
