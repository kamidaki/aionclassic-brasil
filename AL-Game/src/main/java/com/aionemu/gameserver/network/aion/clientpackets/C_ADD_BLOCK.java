 ...
 * @author Ben
 */
public class C_ADD_BLOCK extends AionClientPacket
{

	private static Logger log = LoggerFactory.getLogger(C_ADD_BLOCK.class);

	private String targetName;
	private String reason;

	public C_ADD_BLOCK(int opcode, State state, State... restStates)
	{
