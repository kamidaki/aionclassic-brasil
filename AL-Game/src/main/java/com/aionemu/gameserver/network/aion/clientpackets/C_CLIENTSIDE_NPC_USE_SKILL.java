...
public class C_CLIENTSIDE_NPC_USE_SKILL extends AionClientPacket
{
	private static final Logger log = LoggerFactory.getLogger(C_CLIENTSIDE_NPC_USE_SKILL.class);
	...
	public C_CLIENTSIDE_NPC_USE_SKILL(int opcode, AionConnection.State state, AionConnection.State... restStates)
	{
