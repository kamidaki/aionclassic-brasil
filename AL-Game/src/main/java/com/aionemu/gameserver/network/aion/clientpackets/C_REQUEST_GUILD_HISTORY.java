 ...
 * @author Simple, xTz
 */
public class C_REQUEST_GUILD_HISTORY extends AionClientPacket
{

	private static final Logger log = LoggerFactory.getLogger(C_REQUEST_GUILD_HISTORY.class);

	private int page;
	private int tab;

	public C_REQUEST_GUILD_HISTORY(int opcode, State state, State... restStates)
	{
