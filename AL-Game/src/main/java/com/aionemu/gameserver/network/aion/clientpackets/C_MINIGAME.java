...
public class C_MINIGAME extends AionClientPacket
{
	...
	public C_MINIGAME(int opcode, AionConnection.State state, AionConnection.State... restStates)
	{
		super(opcode, state, restStates);
	}

	private static final Logger log = LoggerFactory.getLogger(C_MINIGAME.class);
