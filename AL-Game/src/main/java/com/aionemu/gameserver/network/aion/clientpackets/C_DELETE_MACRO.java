 ...
 * @author SoulKeeper
 */
public class C_DELETE_MACRO extends AionClientPacket
{

	/**
	 * Logger
	 */
	private static final Logger log = LoggerFactory.getLogger(C_DELETE_MACRO.class);
	 ...
	 * @param opcode
	 */
	public C_DELETE_MACRO(int opcode, State state, State... restStates)
	{
