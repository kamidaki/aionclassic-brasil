...
public class C_CUR_STATUS extends AionClientPacket
{
	private final Logger log = LoggerFactory.getLogger(C_CUR_STATUS.class);
	private byte status;

	public C_CUR_STATUS(int opcode, State state, State... restStates)
	{
