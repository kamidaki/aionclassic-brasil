...
public class C_COMBINE extends AionClientPacket
{
	private static final Logger log = LoggerFactory.getLogger(C_COMBINE.class);
	private int itemID;
	...
	public C_COMBINE(int opcode, State state, State... restStates)
	{
