 ...
 * @author_fix nerolory
 */
public class C_ACTION extends AionClientPacket
{
	private static final Logger log = LoggerFactory.getLogger(C_ACTION.class);
	...
	public C_ACTION(int opcode, State state, State... restStates)
	{
