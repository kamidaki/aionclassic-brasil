 ...
 * @author Cura
 */
public class C_CAPTCHA extends AionClientPacket
{

	/**
	 * Logger
	 */
	private static final Logger log = LoggerFactory.getLogger(C_CAPTCHA.class);
	 ...
	 * @param opcode
	 */
	public C_CAPTCHA(int opcode, State state, State... restStates)
	{
