...
public class C_SELECT_ITEM extends AionClientPacket
{
	...
	private static final Logger log = LoggerFactory.getLogger(C_SELECT_ITEM.class);

	@SuppressWarnings("unused")
	private int unk;

	public C_SELECT_ITEM(int opcode, AionConnection.State state, AionConnection.State... restStates)
	{
