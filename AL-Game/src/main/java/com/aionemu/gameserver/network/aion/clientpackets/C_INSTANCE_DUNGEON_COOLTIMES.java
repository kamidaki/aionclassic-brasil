...
public class C_INSTANCE_DUNGEON_COOLTIMES extends AionClientPacket
{
	private static Logger log = LoggerFactory.getLogger(C_INSTANCE_DUNGEON_COOLTIMES.class);

	@SuppressWarnings("unused")
	private int unk1, unk2;

	public C_INSTANCE_DUNGEON_COOLTIMES(int opcode, State state, State... restStates)
	{
