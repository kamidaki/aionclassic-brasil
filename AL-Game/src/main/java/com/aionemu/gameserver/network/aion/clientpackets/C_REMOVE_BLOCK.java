 ...
 * @author Ben
 */
public class C_REMOVE_BLOCK extends AionClientPacket
{

	private static Logger log = LoggerFactory.getLogger(C_REMOVE_BLOCK.class);
	 ...
	 * @param opcode
	 */
	public C_REMOVE_BLOCK(int opcode, State state, State... restStates)
	{
