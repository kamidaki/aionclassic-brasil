...
public class C_BUY_SELL extends AionClientPacket
{
	private static final Logger log = LoggerFactory.getLogger(C_BUY_SELL.class);
	...
	public C_BUY_SELL(int opcode, State state, State... restStates)
	{
