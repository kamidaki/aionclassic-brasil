...
public class SM_SYSTEM_MESSAGE extends AionServerPacket
{
	 ...
	 */
	public static SM_SYSTEM_MESSAGE STR_MSG_CANNOT_LEAVE_PARTY_DURING_PATH_FLYING(DescriptionId descriptionId) {
		return new SM_SYSTEM_MESSAGE(1300047, descriptionId);
	}
	 ...
	 */
	public static SM_SYSTEM_MESSAGE STR_SKILL_CANT_CAST_THIS_SKILL_IN_CURRENT_STANCE(DescriptionId value0) {
	 ...
	 * %0 gave you %1.
	 */
	public static SM_SYSTEM_MESSAGE STR_GIVE_ITEM_TO_YOU(String playerName, int nameId) {
		return new SM_SYSTEM_MESSAGE(1300391, playerName, new DescriptionId(nameId));
	}
	...
	*/
	 ...
	 * You need %0 Stigma Shard(s) to equip this Stone.
	 */
	public static SM_SYSTEM_MESSAGE STR_STIGMA_CANNT_EQUIP_STONE_OUT_OF_AVAILABLE_STIGMA_POINT(int value0) {
		return new SM_SYSTEM_MESSAGE(1300406, value0);
	}
	 ...
	 */
	public static SM_SYSTEM_MESSAGE STR_DECOMPOSE_ITEM_INVALID_STANCE(DescriptionId descriptionId) {
		return new SM_SYSTEM_MESSAGE(1300451, descriptionId);
	}
	 ...
	 */
	public static SM_SYSTEM_MESSAGE STR_ENCHANT_ITEM_INVALID_STANCE(DescriptionId descriptionId) {
		return new SM_SYSTEM_MESSAGE(1300458, descriptionId);
	}
...
/ChannelHelp: Shows the commands available for channels.
	...
	public static SM_SYSTEM_MESSAGE STR_ABYSS_LOSE_CASTLE_GROUP(DescriptionId descriptionId) {
		return new SM_SYSTEM_MESSAGE(1404543, descriptionId);
	}
	 ...
	 * failed to defend %1.
	 */
	public static SM_SYSTEM_MESSAGE STR_ABYSS_CASTLE_TAKEN(String value0) {
		return new SM_SYSTEM_MESSAGE(1301046, value0);
	}
	 ...
	 */
	public static SM_SYSTEM_MESSAGE STR_MSG_DISABLE(DescriptionId descriptionId) {
		return new SM_SYSTEM_MESSAGE(1390230, descriptionId);
	}
	 ...
	 */
	public static SM_SYSTEM_MESSAGE STR_MSG_CANNOT_ENTER_INSTANCE_COOL_TIME_MIN(int worldname0, int value1) {
	 ...
	 */
	public static SM_SYSTEM_MESSAGE STR_MSG_CANNOT_ENTER_INSTANCE_COOL_TIME_HOUR_CLIENT(int value0, int value1) {
		return new SM_SYSTEM_MESSAGE(1400037, new DescriptionId(value0 * 2 + 1), value1);
	}

	/**
	 * You may enter %0 again after %1 minute(s).
	 */
	public static SM_SYSTEM_MESSAGE STR_MSG_CANNOT_ENTER_INSTANCE_COOL_TIME_MIN_CLIENT(int value0, int value1) {
		return new SM_SYSTEM_MESSAGE(1400038, new DescriptionId(value0 * 2 + 1), value1);
	}

	/**
	 * You can enter %0 area now.
	 */
	public static SM_SYSTEM_MESSAGE STR_MSG_CAN_ENTER_INSTANCE(int value0) {
		return new SM_SYSTEM_MESSAGE(1400031, new DescriptionId(value0 * 2 + 1));
	}
	 ...
	 */
	public static SM_SYSTEM_MESSAGE STR_MSG_LEAVE_INSTANCE(int value0) {
	 ...
	 * You have exited the Instanced Zone. This zone will be reset in %0 minutes.
	 */
	public static SM_SYSTEM_MESSAGE STR_MSG_LEAVE_INSTANCE_PARTY(int value0) {
	 ...
	 * You have exited the Instanced Zone. This zone will be reset in %0 minutes.
	 */
	public static SM_SYSTEM_MESSAGE STR_MSG_LEAVE_INSTANCE_FORCE(int value0) {
	 ...
	 * You used %0.
	 */
	public static SM_SYSTEM_MESSAGE STR_USE_CASH_TYPE_ITEM1(int i) {
		return new SM_SYSTEM_MESSAGE(1400333, new DescriptionId(i));
	}
	...
	public static final SM_SYSTEM_MESSAGE STR_MSG_IDDramata_02 = new SM_SYSTEM_MESSAGE(1401214);
	public static final SM_SYSTEM_MESSAGE STR_MSG_IDDramata_03 = new SM_SYSTEM_MESSAGE(1401215);
	...
	public static final SM_SYSTEM_MESSAGE STR_LEVEL_LIMIT_QUEST_NOT_FINISHED2 = new SM_SYSTEM_MESSAGE(1401901);
	...
	public static final SM_SYSTEM_MESSAGE STR_MSG_INSTANCE_DUNGEON_EXTRA_COUNT_USE = new SM_SYSTEM_MESSAGE(1401677);
	///Entry successful. Entry count consumed.
	public static final SM_SYSTEM_MESSAGE STR_MSG_INSTANCE_DUNGEON_COUNT_USE = new SM_SYSTEM_MESSAGE(1401678);
	...
	public static SM_SYSTEM_MESSAGE STR_MSG_INSTANCE_DUNGEON_NEED_SOLO(String worldname0) {
		return new SM_SYSTEM_MESSAGE(1401717, worldname0);
	}
	...
	*/
	 ...
	 */
	public static SM_SYSTEM_MESSAGE STR_MSG_TOYPET_CANT_SUMMON_STATE(DescriptionId descriptionId) {
		return new SM_SYSTEM_MESSAGE(1400733, descriptionId);
	}
	 ...
	 */
	public static SM_SYSTEM_MESSAGE STR_MSG_TOYPET_CANT_UNSUMMON_STATE(DescriptionId descriptionId) {
		return new SM_SYSTEM_MESSAGE(1400735, descriptionId);
	}
	 ...
	 */
	public static SM_SYSTEM_MESSAGE STR_MSG_SKILL_ITEM_RESTRICTED_AREA(DescriptionId descriptionId, int nameId) {
		return new SM_SYSTEM_MESSAGE(1400905, descriptionId, new DescriptionId(nameId));
	}
	 ...
	 */
	public static SM_SYSTEM_MESSAGE STR_MSG_COMBINE_BROADCAST_COMBINE_SUCCESS(String playerName, int nameId) {
		return new SM_SYSTEM_MESSAGE(1400974, playerName, new DescriptionId(nameId));
	}
	 ...
	 * DAEVA PASS
	 */
	public static SM_SYSTEM_MESSAGE STR_MSG_DEVAPASS_LEVEL_UP(int newLevel) {
		return new SM_SYSTEM_MESSAGE(1401425, newLevel);
	}
	public static final SM_SYSTEM_MESSAGE STR_MSG_DEVAPASS_REWARD_INVENTORY_FULL = new SM_SYSTEM_MESSAGE(1401424);
	 ...
	 * [Quest/Mission]
	 */
	public static final SM_SYSTEM_MESSAGE STR_QUEST_SAY_LF4_15 = new SM_SYSTEM_MESSAGE(1122015);
	public static final SM_SYSTEM_MESSAGE STR_QUEST_SAY_LF4_16 = new SM_SYSTEM_MESSAGE(1122016);
	public static final SM_SYSTEM_MESSAGE STR_QUEST_SAY_LF4_17 = new SM_SYSTEM_MESSAGE(1122017);
	public static final SM_SYSTEM_MESSAGE STR_QUEST_SAY_LF4_18 = new SM_SYSTEM_MESSAGE(1122020);
	public static final SM_SYSTEM_MESSAGE STR_QUEST_SAY_LF4_19 = new SM_SYSTEM_MESSAGE(1122021);
	public static final SM_SYSTEM_MESSAGE STR_QUEST_SAY_LF4_20 = new SM_SYSTEM_MESSAGE(1122022);
	public static final SM_SYSTEM_MESSAGE STR_QUEST_SAY_IDNovice_02 = new SM_SYSTEM_MESSAGE(1122018);
	public static final SM_SYSTEM_MESSAGE STR_QUEST_SAY_IDNovice_03 = new SM_SYSTEM_MESSAGE(1122019);
	
	public static final SM_SYSTEM_MESSAGE STR_CHAT_IDCatacombs_BonedrakeNmd_55_Ah_Start1 = new SM_SYSTEM_MESSAGE(1500070);
	public static final SM_SYSTEM_MESSAGE STR_CHAT_IDCatacombs_BonedrakeNmd_55_Ah_Skill1 = new SM_SYSTEM_MESSAGE(1500071);
	public static final SM_SYSTEM_MESSAGE STR_CHAT_IDCatacombs_BonedrakeNmd_55_Ah_Die1 = new SM_SYSTEM_MESSAGE(1500072);
	public static final SM_SYSTEM_MESSAGE STR_CHAT_IDCatacombs_ElementalFireNmd_55_Ah_Skill1 = new SM_SYSTEM_MESSAGE(1500077);
	public static final SM_SYSTEM_MESSAGE STR_CHAT_IDCatacombs_ElementalFireNmd_55_Ah_Die1 = new SM_SYSTEM_MESSAGE(1500078);
	
	public static final SM_SYSTEM_MESSAGE STR_MSG_INSTANCE_OPEN_IDTiamatLab_War = new SM_SYSTEM_MESSAGE(1401498);
	
	public static final SM_SYSTEM_MESSAGE STR_MISSION_ACQUIRE_MESSAGE = new SM_SYSTEM_MESSAGE(1100004);
	
	/**
	 * Combination Tool
	 */
	public static final SM_SYSTEM_MESSAGE STR_MSG_COMPOUND_ENCHANTSTONE_FULL_INVENTORY = new SM_SYSTEM_MESSAGE(1401509);
	public static SM_SYSTEM_MESSAGE STR_MSG_COMPOUND_ENCHANTSTONE_CANT(int nameId) {
		return new SM_SYSTEM_MESSAGE(1401505, new DescriptionId(nameId));
	}
	public static final SM_SYSTEM_MESSAGE STR_MSG_COMPOUND_ENCHANTSTONE_CANT_LEVEL(int level) {
		return new SM_SYSTEM_MESSAGE(1401506, level);
	}
	public static SM_SYSTEM_MESSAGE STR_MSG_COMPOUND_ENCHANTSTONE_COMPLETE(int nameId, int objectNameId) {
		return new SM_SYSTEM_MESSAGE(1401507, new DescriptionId(nameId), calculateNameId(objectNameId));
	}
	public static SM_SYSTEM_MESSAGE STR_MSG_COMPOUND_ENCHANTSTONE_CANCEL(int nameId, int objectNameId) {
		return new SM_SYSTEM_MESSAGE(1401508, new DescriptionId(nameId), calculateNameId(objectNameId));
	}
	
	public static SM_SYSTEM_MESSAGE STR_ABYSS_OCCUPY_COUNT_MAX(String value0) {
		return new SM_SYSTEM_MESSAGE(1401588, value0);
	}
	public static SM_SYSTEM_MESSAGE STR_ABYSS_OCCUPY_CHANGE_DRAGON(String value0) {
		return new SM_SYSTEM_MESSAGE(1401589, value0);
	}
	
	public static final SM_SYSTEM_MESSAGE STR_MSG_Station_DoorCtrl_Evileye = new SM_SYSTEM_MESSAGE(1401350);
	public static final SM_SYSTEM_MESSAGE STR_MSG_Station_Boss_ForAct = new SM_SYSTEM_MESSAGE(1401391);
	
	public static final SM_SYSTEM_MESSAGE STR_MSG_IDElemental1_Unicorn_SpawnActionOBJ = new SM_SYSTEM_MESSAGE(1401031);
	public static final SM_SYSTEM_MESSAGE STR_MSG_IDElemental1_GolemPrime_SpawnActionOBJ = new SM_SYSTEM_MESSAGE(1401032);
	public static final SM_SYSTEM_MESSAGE STR_MSG_IDElemental1_GolemPrime_Resurrection = new SM_SYSTEM_MESSAGE(1401033);
	public static final SM_SYSTEM_MESSAGE STR_MSG_IDElemental1_Unicorn_ReturnToSp = new SM_SYSTEM_MESSAGE(1401035);
	public static final SM_SYSTEM_MESSAGE STR_MSG_IDElemental1_GolemPrime_Forest_Overclock = new SM_SYSTEM_MESSAGE(1401041);
	public static final SM_SYSTEM_MESSAGE STR_MSG_IDElemental1_Prime_Debuff_Dispel = new SM_SYSTEM_MESSAGE(1401378);
	
	public static final SM_SYSTEM_MESSAGE STR_MSG_IDRaksha_AppearMirror = new SM_SYSTEM_MESSAGE(1401136);
	public static final SM_SYSTEM_MESSAGE STR_MSG_IDRaksha_MirrorNMD_Teleport = new SM_SYSTEM_MESSAGE(1401137);
	public static final SM_SYSTEM_MESSAGE STR_MSG_IDRaksha_MirrorNMDHeavyATK = new SM_SYSTEM_MESSAGE(1401138);
	public static final SM_SYSTEM_MESSAGE STR_MSG_IDRaksha_FireNMDAreaSummon = new SM_SYSTEM_MESSAGE(1401139);
	public static final SM_SYSTEM_MESSAGE STR_MSG_IDRaksha_StatueWakeup = new SM_SYSTEM_MESSAGE(1401140);
	public static final SM_SYSTEM_MESSAGE STR_MSG_IDRaksha_WeakRakshaSpawn = new SM_SYSTEM_MESSAGE(1401162);
	public static final SM_SYSTEM_MESSAGE STR_MSG_IDRaksha_DrakanGiantSheildDispel = new SM_SYSTEM_MESSAGE(1401279);
	...
	public static final SM_SYSTEM_MESSAGE STR_MSG_LDF4a_windpath163_Ready = new SM_SYSTEM_MESSAGE(1401330);
	public static final SM_SYSTEM_MESSAGE STR_MSG_LDF4a_windpath163_Open = new SM_SYSTEM_MESSAGE(1401331);
	public static final SM_SYSTEM_MESSAGE STR_MSG_LDF4a_windpath163_Close = new SM_SYSTEM_MESSAGE(1401332);
	
	public static final SM_SYSTEM_MESSAGE STR_MSG_LDF4a_SandWarm_Skill_Hide = new SM_SYSTEM_MESSAGE(1401285);
	public static final SM_SYSTEM_MESSAGE STR_MSG_LDF4a_SandWarm_Skill_SummonHole = new SM_SYSTEM_MESSAGE(1401299);
	public static final SM_SYSTEM_MESSAGE STR_MSG_LDF4a_SandWarm_Skill_Sandfit = new SM_SYSTEM_MESSAGE(1401300);
	public static final SM_SYSTEM_MESSAGE STR_MSG_LDF4a_Lost_Guardian_Skill_Area_Left = new SM_SYSTEM_MESSAGE(1401286);
	public static final SM_SYSTEM_MESSAGE STR_MSG_LDF4a_Lost_Guardian_Skill_Area_Right = new SM_SYSTEM_MESSAGE(1401287);
	public static final SM_SYSTEM_MESSAGE STR_MSG_LDF4a_Lost_Guardian_Skill_Area_Middle = new SM_SYSTEM_MESSAGE(1401288);
	public static final SM_SYSTEM_MESSAGE STR_MSG_LDF4a_Lost_Guardian_Skill_Final = new SM_SYSTEM_MESSAGE(1401301);
	public static final SM_SYSTEM_MESSAGE STR_MSG_LDF4a_Owllau_Wizard_Chieftain_Skill_forAct = new SM_SYSTEM_MESSAGE(1401289);
	public static final SM_SYSTEM_MESSAGE STR_MSG_LDF4a_Owllau_Wizard_Chieftain_Skill_Penalty = new SM_SYSTEM_MESSAGE(1401290);
	public static final SM_SYSTEM_MESSAGE STR_MSG_Calydon_Fighter_Patriarch_Skill_forAct = new SM_SYSTEM_MESSAGE(1401291);
	public static final SM_SYSTEM_MESSAGE STR_MSG_Calydon_Fighter_Patriarch_Skill_Penalty = new SM_SYSTEM_MESSAGE(1401292);
	
	public static final SM_SYSTEM_MESSAGE STR_GUILD_JOIN_REFUSAL = new SM_SYSTEM_MESSAGE(1401889);
	public static final SM_SYSTEM_MESSAGE STR_GUILD_JOIN_APPORVE = new SM_SYSTEM_MESSAGE(1401890);
	
	///Purification Ritual
	public static final SM_SYSTEM_MESSAGE STR_MSG_PURIFY_SUCCESS = new SM_SYSTEM_MESSAGE(1401470);
	public static final SM_SYSTEM_MESSAGE STR_MSG_PURIFY_NOMONEY = new SM_SYSTEM_MESSAGE(1401471);
	public static final SM_SYSTEM_MESSAGE STR_MSG_PURIFY_DONOT = new SM_SYSTEM_MESSAGE(1401472);
	
	public static final SM_SYSTEM_MESSAGE STR_MSG_INDUN_NEW_ENTRANCE = new SM_SYSTEM_MESSAGE(1401752);
	
	/**
	 *
	 * WardRobe
	 */
	public static final SM_SYSTEM_MESSAGE STR_MSG_WARDROBE_COMPLETE_EXPAND_SLOT = new SM_SYSTEM_MESSAGE(1401551);
	public static final SM_SYSTEM_MESSAGE STR_MSG_WARDROBE_COMPLETE_REGISTER_ITEM(int value0) {
		return new SM_SYSTEM_MESSAGE(1401541, new DescriptionId(value0));
	}
	public static final SM_SYSTEM_MESSAGE STR_MSG_WARDROBE_FAVORITE_ITEM(int value0) {
		return new SM_SYSTEM_MESSAGE(1401543, new DescriptionId(value0));
	}
	public static final SM_SYSTEM_MESSAGE STR_MSG_WARDROBE_COMPLETE_DYE(int value0, int value1) {
		return new SM_SYSTEM_MESSAGE(1401565, new DescriptionId(value0), new DescriptionId(value1));
	}
	public static final SM_SYSTEM_MESSAGE STR_MSG_WARDROBE_COMPLETE_REMOVE_DYE(int value0) {
		return new SM_SYSTEM_MESSAGE(1401566, new DescriptionId(value0));
	}
	public static final SM_SYSTEM_MESSAGE STR_MSG_WARDROBE_DELETE_ITEM(int value0) {
		return new SM_SYSTEM_MESSAGE(1401542, new DescriptionId(value0));
	}
	
	/**
	 * Upgrade Arcade
	 */
	public static final SM_SYSTEM_MESSAGE STR_MSG_NOT_ENOUGH_TRADE_MONEY = new SM_SYSTEM_MESSAGE(1400557, "[item:" + 186000389 + "]");
	public static SM_SYSTEM_MESSAGE STR_MSG_GACHA_ITEM_REWARD(int itemId) {
		return new SM_SYSTEM_MESSAGE(1401763, "[item:" + itemId + "]");
	}
	public static SM_SYSTEM_MESSAGE STR_MSG_GACHA_ITEM_REWARD_MULTI(int itemId, int count) {
		return new SM_SYSTEM_MESSAGE(1401764, "[item:" + itemId + "]", count);
	}
	public static final SM_SYSTEM_MESSAGE STR_MSG_GACHA_FEVERTIME_START = new SM_SYSTEM_MESSAGE(1401750);
	public static final SM_SYSTEM_MESSAGE STR_MSG_GACHA_TIME_END = new SM_SYSTEM_MESSAGE(1401749);
	public static SM_SYSTEM_MESSAGE STR_MSG_GACHA_FEVER_ITEM_REWARD(int itemId) {
		return new SM_SYSTEM_MESSAGE(1401765, "[item:" + itemId + "]");
	}
	public static SM_SYSTEM_MESSAGE STR_MSG_GACHA_FEVER_ITEM_REWARD_MULTI(int itemId, int count) {
		return new SM_SYSTEM_MESSAGE(1401766, "[item:" + itemId + "]", count);
	}
	
	public static final SM_SYSTEM_MESSAGE STR_MSG_IDTiamatLab_Q_Doorkeeper = new SM_SYSTEM_MESSAGE(1401540);
	public static final SM_SYSTEM_MESSAGE STR_GOSSHIP_IDTiamatLab_Q_Mission_01 = new SM_SYSTEM_MESSAGE(1500299);
	public static final SM_SYSTEM_MESSAGE STR_GOSSHIP_IDTiamatLab_Q_Mission_02 = new SM_SYSTEM_MESSAGE(1500300);
	public static final SM_SYSTEM_MESSAGE STR_GOSSHIP_IDTiamatLab_Q_Mission_03 = new SM_SYSTEM_MESSAGE(1500301);
	public static final SM_SYSTEM_MESSAGE STR_GOSSHIP_IDTiamatLab_Q_Mission_04 = new SM_SYSTEM_MESSAGE(1500302);
	
	public static final SM_SYSTEM_MESSAGE STR_SKILL_EFFECT_TIMEFREEZING_BEGIN = new SM_SYSTEM_MESSAGE(1401838);
	public static final SM_SYSTEM_MESSAGE STR_SKILL_EFFECT_TIMEFREEZING_END = new SM_SYSTEM_MESSAGE(1401839);
	
	//[%SkillName]%을 사용해 시간 제어 상태가 됐습니다.
	public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_TimeFreezing_ME_TO_SELF(String skillname) {
		return new SM_SYSTEM_MESSAGE(1401840, skillname);
	}
	//시간 제어 상태에서 벗어났습니다.
	public static final SM_SYSTEM_MESSAGE STR_SKILL_SUCC_TimeFreezing_END_ME_TO_SELF = new SM_SYSTEM_MESSAGE(1401841);
	//[%SkillName]%을 사용해 [%SkillTarget]%이 시간 제어 상태가 됐습니다.
	public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_TimeFreezing_ME_TO_B(String skilltarget, String skillname) {
		return new SM_SYSTEM_MESSAGE(1401842, skilltarget, skillname);
	}
	//[%SkillTarget]%이 시간 제어 상태에서 벗어났습니다.
	public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_TimeFreezing_END_ME_TO_B(String skilltarget) {
		return new SM_SYSTEM_MESSAGE(1401843, skilltarget);
	}
	//[%SkillCaster]%이 사용한 [%SkillName]의 영향으로 시간 제어 상태가 됐습니다.
	public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_TimeFreezing_A_TO_ME(String skillcaster, String skillname) {
		return new SM_SYSTEM_MESSAGE(1401844, skillcaster, skillname);
	}
	//시간 제어 상태에서 벗어났습니다.
	public static final SM_SYSTEM_MESSAGE STR_SKILL_SUCC_TimeFreezing_END_A_TO_ME = new SM_SYSTEM_MESSAGE(1401845);
	//[%SkillCaster]%가 [%SkillName]%을 사용해 시간 제어 상태가 됐습니다.
	public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_TimeFreezing_A_TO_SELF(String skillcaster, String skillname) {
		return new SM_SYSTEM_MESSAGE(1401846, skillcaster, skillname);
	}
	//[%SkillTarget]%이 시간 제어 상태에서 벗어났습니다.
	public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_TimeFreezing_END_A_TO_SELF(String skilltarget) {
		return new SM_SYSTEM_MESSAGE(1401847, skilltarget);
	}
	//[%SkillCaster]%이 [%SkillName]%을 사용해 [%SkillTarget]%이 시간 제어 상태가 됐습니다.
	public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_TimeFreezing_A_TO_B(String skilltarget, String skillcaster, String skillname) {
		return new SM_SYSTEM_MESSAGE(1401848, skilltarget, skillcaster, skillname);
	}
	//[%SkillTarget]%이 시간 제어 상태에서 벗어났습니다.
	public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_TimeFreezing_END_A_TO_B(String skilltarget) {
		return new SM_SYSTEM_MESSAGE(1401849, skilltarget);
	}
	//시간 제어 상태에서 벗어났습니다.
	public static final SM_SYSTEM_MESSAGE STR_SKILL_SUCC_TimeFreezing_END_ME = new SM_SYSTEM_MESSAGE(1401850);
	//%0%이 시간 제어 상태에서 벗어났습니다.
	public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_TimeFreezing_END_A(String value0) {
		return new SM_SYSTEM_MESSAGE(1401851, value0);
	}
	
	public static final SM_SYSTEM_MESSAGE STR_MSG_IDLDF1_BionicCPUNamed_55_Ah_EnterAttack = new SM_SYSTEM_MESSAGE(1401993);
