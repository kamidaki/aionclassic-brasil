...
public class C_HACTION extends AionClientPacket
{
	...
	@SuppressWarnings("unused")
	private static final Logger log = LoggerFactory.getLogger(C_HACTION.class);

	public C_HACTION(int opcode, State state, State... restStates)
	{
