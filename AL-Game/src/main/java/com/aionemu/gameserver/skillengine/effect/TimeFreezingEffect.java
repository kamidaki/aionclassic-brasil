...
public class TimeFreezingEffect extends EffectTemplate
{
	...
	public void startEffect(Effect effect) {
		...
		//몸이 시간 제어됐습니다.
        PacketSendUtility.sendPacket(effector, SM_SYSTEM_MESSAGE.STR_SKILL_EFFECT_TIMEFREEZING_BEGIN);
	}
	...
	public void endEffect(Effect effect) {
		...
		//몸의 시간 제어가 풀렸습니다.
        PacketSendUtility.sendPacket(effector, SM_SYSTEM_MESSAGE.STR_SKILL_EFFECT_TIMEFREEZING_END);
	}
}